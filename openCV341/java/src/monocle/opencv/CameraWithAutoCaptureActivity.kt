...
//        val bitmap2Height = bitmap2.getHeight()
    ...
    private fun imageCrop(bitmap: Bitmap): Bitmap {
        ...
        val p0 =
            org.opencv.core.Point(cropView.points[0]!!.x.toDouble() + delta, cropView.points[0]!!.y.toDouble() + delta)
        val p1 =
            org.opencv.core.Point(cropView.points[2]!!.x.toDouble() + delta, cropView.points[2]!!.y.toDouble() + delta)
        val p2 =
            org.opencv.core.Point(cropView.points[3]!!.x.toDouble() + delta, cropView.points[3]!!.y.toDouble() + delta)
        val p3 =
            org.opencv.core.Point(cropView.points[1]!!.x.toDouble() + delta, cropView.points[1]!!.y.toDouble() + delta)
        sourcePoints.add(p0)
        sourcePoints.add(p1)
        sourcePoints.add(p2)
        sourcePoints.add(p3)
